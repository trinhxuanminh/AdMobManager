...
let package = Package(
  ...
  dependencies: [
    ...
    .package(name: "GoogleMobileAds", url: "https://github.com/googleads/swift-package-manager-google-mobile-ads.git", from: "11.6.0"),
    .package(url: "https://github.com/firebase/firebase-ios-sdk", from: "10.28.0"),
    .package(url: "https://github.com/AppsFlyerSDK/AppsFlyerFramework", from: "6.14.4"),

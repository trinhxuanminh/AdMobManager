...
@IBDesignable public class Size3NativeAdView: BaseView, GADVideoControllerDelegate {
  ...
  override func addComponents() {
    Bundle.module.loadNibNamed(String(describing: Size3NativeAdView.self),
                               owner: self,
                               options: nil)

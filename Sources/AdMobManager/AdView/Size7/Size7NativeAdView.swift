...
@IBDesignable public class Size7NativeAdView: BaseView, GADVideoControllerDelegate {
  ...
  override func addComponents() {
    Bundle.module.loadNibNamed(String(describing: Size7NativeAdView.self),
                               owner: self,
                               options: nil)
  ...
  override func setProperties() {
    ...
    adBackgroundView.layer.maskedCorners = [.layerMinXMaxYCorner]

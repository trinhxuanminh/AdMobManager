...
@IBDesignable public class Size2NativeAdView: BaseView, GADVideoControllerDelegate {
  ...
  override func addComponents() {
    Bundle.module.loadNibNamed(String(describing: Size2NativeAdView.self),
                               owner: self,
                               options: nil)

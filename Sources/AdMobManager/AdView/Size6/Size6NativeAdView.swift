...
@IBDesignable public class Size6NativeAdView: BaseView, GADVideoControllerDelegate {
  ...
  override func addComponents() {
    Bundle.module.loadNibNamed(String(describing: Size6NativeAdView.self),
                               owner: self,
                               options: nil)
  ...
  public class func adHeightMinimum(width: CGFloat) -> CGFloat {
    ...
    return (mediaHeight < 120 ? 120 : mediaHeight) + 223
  }

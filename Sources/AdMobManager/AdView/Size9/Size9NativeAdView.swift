...
@IBDesignable public class Size9NativeAdView: BaseView, GADVideoControllerDelegate {
  ...
  override func addComponents() {
    Bundle.module.loadNibNamed(String(describing: Size9NativeAdView.self),
                               owner: self,
                               options: nil)

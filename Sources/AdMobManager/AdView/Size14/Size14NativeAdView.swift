...
@IBDesignable public class Size14NativeAdView: BaseView, GADVideoControllerDelegate {
  ...
  @IBOutlet weak var firstAdBackgroundView: UIView!
  @IBOutlet weak var secondAdBackgroundView: UIView!
  ...
  override func addComponents() {
    Bundle.module.loadNibNamed(String(describing: Size14NativeAdView.self),
                               owner: self,
                               options: nil)
  ...
  override func setProperties() {
    ...
    callToActionButton.layer.cornerRadius = 10.0
  ...
  public func changeColor(
    ...
    if let adBackground = adBackground {
      firstAdBackgroundView.backgroundColor = adBackground
      secondAdBackgroundView.backgroundColor = adBackground
    }
    if let ad = ad {

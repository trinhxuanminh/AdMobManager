...
## Demo
Refer to the following [Demo project](https://github.com/trinhxuanminh/DemoAdMobManager/tree/develop/3.1.0) to implement the ad.
...
### 3. NativeAd
- Download & add file [`CustomNativeAdView.xib`](https://github.com/trinhxuanminh/AdMobManager/blob/develop/3.0.0/Sources/AdMobManager/Template/CustomNativeAdView.xib).
